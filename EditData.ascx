<%@ Control Language="C#" AutoEventWireup="false" Inherits="Satrabel.OpenForm.EditData" CodeBehind="EditData.ascx.cs" %>
...
<div class="dnnForm dnnRazorHostEditScript dnnClear" id="dnnEditScript">
    ...
    <ul class="dnnActions dnnClear">
        ...
        <li>
            <a href="http://www.convertcsv.com/json-to-csv.htm" target="_blank">Convert to csv or Excel</a>
        </li>
